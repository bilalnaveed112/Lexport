...
$lang['WELCOME_HOME'] = "Welcome to Nassr Albarakati & Partners Law Firm";
...
$lang["our_service_text_top"] = "We offer our clients distinguished legal services through the best attorneys, advisors, and former judges in addition to an integrated team work of specialists and experts to provide all legal support means and continuous assistance.";

$lang["Law_consultancy_and_studie"] = "Law consultancy and studie";
...
$lang["Law_consultancy_and_studie_p2"] = "<li>Provide legal consultancy and answers to all inquiries and consultancies.</li><li>Prepare specialized studies and memos in several fields in a way ensuring taking right decision and quick execution of business.</li><li>Offer practical solutions effective in business market which help clients to avoid entering court houses.</li>";
...
$lang["Contracts_and_Agreements_p2"] = "<li>Prepare and review civil and commercial contracts and agreements and provide legal support through negotiation phase.</li><li>Review clearances and letters, avoiding being in conflict with laws and regulations as well as preparing the needed annexes.</li><li>Review internal regulations and regulatory decisions relevant to the company.</li>";
...
$lang["Arbitration_and_Mediation_p2"] = "<li>Perform dispute resolution tasks, reconciliation through commercial mediation and settlement of disputes among parties in addition to provision of detailed analysis for facts and circumstances relevant to each dispute, provide alternative solutions for challenges in commercial agreements where we have flexible means to resolve disputes quickly in participation of all parties.</li><li>Our team includes certified arbitrators who have large experience in local and international arbitration; we also represent companies in arbitration tribunals and initiation of commercial investment cases.</li>";
