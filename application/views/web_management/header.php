<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" dir="<?php if($this->session->userdata('admin_site_lang')=="arabic" OR $this->session->userdata('admin_site_lang')=="") echo "rtl"; else echo ""; ?>" xml:lang="en" lang="<?php if($this->session->userdata('admin_site_lang')=="arabic") echo "an"; else echo "en"; ?>">
<head>

    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title><?= (isset($pageTitle)) ? $pageTitle . ' |' : ''; ?> <?php echo $this->lang->line('ALBARAKATI_LAW');?></title>
...
if (!$this->session->userdata('admin_id')) {
	return redirect('web_management/cms/login');
}
?>
<body>
...
<li class="m-nav__item m-topbar__languages " m-dropdown-toggle="click" aria-expanded="true">
<?php if($this->session->userdata('admin_site_lang') == "arabic" OR $this->session->userdata('admin_site_lang') == "") {  ?>
		<a href="<?php echo base_url('web_management/cmslangswitch/switchLanguage/english'); ?>" class="m-nav__link m-dropdown__toggle">
		<span class="m-nav__link-text">
...
<?php } else { ?>
		...
		<a href="<?php echo base_url('web_management/cmslangswitch/switchLanguage/arabic'); ?>" class="m-nav__link m-dropdown__toggle">
		<span class="m-nav__link-text">
...
<?php } ?>
 ...
 <li class="m-nav__item m-topbar__languages m-dropdown m-dropdown--small m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--mobile-full-width" m-dropdown-toggle="click" aria-expanded="true">
	<a href="#" class="m-nav__link m-dropdown__toggle">
		<span class="m-nav__link-text">
			<img class="m-topbar__language-selected-img" src="<?php echo base_url()?>/uploads/profile/defualt_profile.png">	
		</span>
	</a>
				...
				<div class="m-dropdown__content">
					<ul class="m-nav m-nav--skin-light">
						...
						<li class="m-nav__item">
							<a href="<?php echo base_url('web_management/cms/logout'); ?>" class="m-nav__link m-nav__link--active">
            ...
            <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
                <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow">
                    ...
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Dashboard');?></span>
                        </a>
                    </li>

                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/list_team_members');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Team_List');?></span>
                        </a>
                    </li>

                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/list_clients');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Clients_List');?></span>
                        </a>
                    </li>

                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/training');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Training_List');?></span>
                        </a>
                    </li>
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/list_news');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('News_List');?></span>
                        </a>
                    </li>

                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/list_articles');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text">Articles<?php echo $this->lang->line('articles');?></span>
                        </a>
                    </li>
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/contact_inquery');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Contact_Inquery');?></span>
                        </a>
                    </li>
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/list_job');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Job_List');?></span>
                        </a>
                    </li>
					 <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/list_pages');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text">Pages<?php //echo $this->lang->line('Subscriber_List');?></span>
                        </a>
                    </li>
                  
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/subscriber_list');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Subscriber_List');?></span>
                        </a>
                    </li> 
                    <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/evidence');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('PLEADER_GUID');?></span>
                        </a>
                    </li> 
                        <li class="m-menu__item" aria-haspopup="true">
                        <a href="<?=base_url('web_management/cms/evidence_list');?>" class="m-menu__link link_men_bg">
                            <span class="m-menu__link-text">Evidence List<?php // echo $this->lang->line('PLEADER_GUID');?></span>
                        </a>
                    </li> 
