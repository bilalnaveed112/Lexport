...
<?php echo form_open_multipart('web_management/cms/store_clients',['id'=>'employer','class'=>"m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"]);
...
<?php 
	...
	if($data)
		...
		<div class="form-group col-sm-12">
			<label for="dob" class=" form-control-label"><?php echo $this->lang->line('Discription');?></label>
			<?php if($data)
			{
