                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <?php echo $this->lang->line('Job_List');?>
                            </h3>
                        </div>
                    </div>
                </div>
...
<a class="btn btn-success btn-lg" href="<?=base_url('web_management/cms/add_job');?>"><?php echo $this->lang->line('Add_Job');?></a><br>      </div>
	  <table id="bootstrap-data-table" class="table table-striped table-bordered tablecase">
            ...
            <td class="action">
                <?php 
                    $jobs = $this->db->get('job_employment')->result_array(); 
                    $count_jobs = count($jobs);
                    if($count_jobs > 0)
                    {
                ?>
				<a href="<?= base_url("web_management/cms/view_job/{$data['id']}") ?>" title="<?php echo $this->lang->line('Resumes');?>"><i class="fa fa-user" aria-hidden="true"></i></a>&nbsp;&nbsp;
				<?php } ?>
				<a href="<?= base_url("web_management/cms/view_job/{$data['id']}") ?>" title="<?php echo $this->lang->line('View');?>" class="fa fa-eye"></a>&nbsp;&nbsp;
				
              <a href="<?= base_url("web_management/cms/find_job/{$data['id']}") ?>"class="fa fa-pencil-square-o editadmin" title="<?php echo $this->lang->line('Edit');?>"></a>&nbsp;&nbsp;
