                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                             Add Article<?php //echo $this->lang->line('JOB');?>
                            </h3>
                        </div>
                    </div>
                </div>
 
<?php echo form_open_multipart('web_management/cms/store_article',['class'=>"m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"]); 
			if($data)
			{
