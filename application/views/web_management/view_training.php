        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                             <?php echo $this->lang->line('Training');?>
                            </h3>
                        </div>
                    </div>
                </div>
				<div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
					...
					<div class="col-md-12">
						<?php echo $this->lang->line('Training_Title');?> :	<?php echo $title;?>
					</div>
					<div class="col-md-12">
						<?php echo $this->lang->line('Training_Description');?> : <?php echo $description;?>
					</div>	
				</div>
        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
				...
				<div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin:10px;">
					<?php $result = $this->db->where('job_id',$data['id'])->get('training_employment')->result_array(); ?>
