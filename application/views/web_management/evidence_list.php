                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                Evidence list <?php //echo $this->lang->line('Job_List');?>
                            </h3>
                        </div>
                    </div>
                </div>
...
<a class="btn btn-success btn-lg" href="<?=base_url('web_management/cms/add_evidence');?>">Add evidence<?php //echo $this->lang->line('Add_Job');?></a><br>      </div>
	  <table id="bootstrap-data-table" class="table table-striped table-bordered tablecase">
			...
			<tbody>
              ...
              <a href="<?= base_url("web_management/cms/find_evidence/{$data['id']}") ?>"class="fa fa-pencil-square-o editadmin" title="<?php echo $this->lang->line('Edit');?>"></a>&nbsp;&nbsp;
...
$(document).ready(function()
{
 ...
 <script type="text/javascript">
  ...
  var id=$(this).attr("id");
  var url="<?= base_url('web_management/cms/delete_evidence'); ?>"; 
   bootbox.confirm("Are you sure to delete evidence?", function(result){
    if(result)
    {
      $.ajax({
    type:'ajax',
