...
$pageTitle = $this->lang->line('Join_us');
include('header.php');
?>
    ...
    <section class="t-center pt relative">
        <div class="container relative zi-1" style="z-index: 1;">
            ...
            <p class="gray6 font-16 xxs-mt">
               <?php echo $this->lang->line('Join_us_our_team');?>
            </p>
				    ...
				    <li style="border-bottom: 1px dashed gray;padding: 20px 0;">
				        <div class="row clearfix">
    				        <div class="col-md-2 col-sm-12">
    				            <div class="imgThumb">
    				                <img src="<?php echo base_url('uploads/job/'.$data['image']);?>" class="">
    				            </div>
    				        </div>
    					    <div class="col-md-10 col-sm-12">
                                ...
                                ?>
    						    <h3><a href="<?= base_url('front/job_details/'.$data['id']); ?>"><?= $title; ?></a></h3>
    						    <p><?= substr($description,0,150); ?><?php if(strlen($description) > 150){?><a href="<?= base_url('front/job_details/'.$data['id']); ?>">...<?php echo $this->lang->line('read_more');?></a><?php } ?></p>
    						    <a href="<?php echo base_url('front/job_employment/job/'.$data['id']);?>" class="bg-colored1 sm-btn font-12 xxs-mt slow width-auto click-effect white bold qdr-hover-6 radius-lg"><?php echo $this->lang->line('Apply_Now');?></a>
    						</div>
						</div>
					</li>
				<?php } ?>
