...
<section id="content" class="sm-pb xxs-mb">
    ...
    <?php if(isset($next)) { ?>
    <a href="https://albarakatilaw.com/front/article_details/<?php echo $next ?>" class="pagination right"> <?php echo $this->lang->line("Next");?> &nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></a>
    <?php } if(isset($prev)) { ?>
    <a href="https://albarakatilaw.com/front/article_details/<?php echo $prev ?>" class="pagination left"><i class="fa fa-arrow-left" aria-hidden="true"></i>  &nbsp; <?php echo $this->lang->line("Previous");?></a>
    <?php } ?>
    </div>
