            ...
            <form id=" " action="front/contact_us_data" name="contact_form" method="post" data-max-file-size="2000000" data-max-file-size-error="File size must be less than 2mb" enctype="multipart/form-data">
                ...
                <div class="row no-mx">
                    <div class="col-sm-6 col-xs-12 no-pl mini-pr">
                        <!-- Name -->
                        <input type="text" name="name" id="name" required placeholder="Name" class="classic_form big radius-lg bg-white bs-light-focus">
                    </div>
                    <div class="col-sm-6 col-xs-12 no-pr mini-pl">
                        <!-- Email -->
                        <input type="email" name="email" id="email" required placeholder="E-Mail" class="classic_form big radius-lg bg-white bs-light-focus">
                    </div>
                </div>
                <div class="row no-mx">
                    <div class="col-sm-6 col-xs-12 no-pr mini-pl">
                       
                        <input type="text" name="subject" id="subject" required placeholder="Subject" class="classic_form big radius-lg bg-white bs-light-focus">
                    </div>
                
                    <div class="col-sm-6 col-xs-12 no-pr mini-pl">
                       
                        <input type="text" name="phone" id="subject" required placeholder="Phone" class="classic_form big radius-lg bg-white bs-light-focus">
                    </div>
                </div>
                <!-- Message -->
                <textarea name="message" id="message" placeholder="Message" class="classic_form big radius bg-white bs-light-focus"></textarea>
...
<div class="row" id="maps">
    <div class="col-md-4">
        <div style="text-align: center;padding: 10px;font-size: 16px;background: #ffffff;color: #000000;">Mecca</div>
    ...
    <div class="col-md-4">
        <div style="text-align: center;padding: 10px;font-size: 16px;background: #ffffff;color: #000000;">Jeddah</div>
    ...
    <div class="col-md-4">
        <div style="text-align: center;padding: 10px;font-size: 16px;background: #ffffff;color: #000000;">Riyadh</div>
