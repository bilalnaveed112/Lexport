...
$pageTitle = $this->lang->line("Writings_Mission");
include('header.php');
...
span.m-widget4__ext {
    ...
    <?php } ?>
	.view_writing_appointment {
		font-family: 'Roboto';
	}
	.view_writing_appointment .m-portlet.lp-theme-card {
		background: unset;
		box-shadow: unset;
		padding: 0;
		border-radius: 0;
	}
	.view_writing_appointment .m-portlet.lp-theme-card .m-portlet__body .in_fo {
		background: #fff;
		margin-left: 0;
	}
	.view_writing_appointment span.card_label {
        font-size: 16px;
        color: #868DA6;
        font-weight: bold;
    }

    .view_writing_appointment span.value {
        font-size: 15px;
        color: #1B2A39;
    }
	.gap_14 {
	...
	.view_writing_appointment .m-portlet__body .in_fo {
		border-radius: 20px;
	}

	html[dir="rtl"] .view_writing_appointment .m-portlet__body .in_fo{
		margin-right: 0;
	}
	.view_writing_appointment .form-group.m-form__group.row.sub-missions{
		padding-left: 15px;
		padding-right: 15px;
	}
	.view_writing_appointment .m-portlet__head .m-portlet__head-title{
		gap: 20px;
	}
	html[dir="rtl"] .view_writing_appointment .m-portlet__head a.back-link svg {
...
<!-- END: Left Aside -->
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        <!-- END: Subheader -->
        <div class="m-content view_writing_appointment">
				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title d-flex">
						...
						<h3 class="m-portlet__head-text">
							<?php echo $this->lang->line('Writing_Details');?>
						</h3>
					</div>
				</div>
			</div>
				...
				<div class="m-portlet__body">
					...
					<div class="in_fo pt-4 mb-8">		
						<div class="form-group m-form__group row">
							...
							<div class="form-group col-sm-2 d-flex flex-column gap_14 my-4">
								<span class="card_label"><?php echo $this->lang->line('Writings_Number');?></span>
								<span class="value"><?php echo $data->session_number; ?></span>
							</div>
							<div class="form-group col-sm-2 d-flex flex-column gap_14 my-4">
								<span class="card_label"><?php echo $this->lang->line('Writings_Date');?></span>
								<span class="value"><?php echo getTheDayAndDateFromDatePanFront($data->session_date); ?></span>
							</div>
							<div class="form-group col-sm-2 d-flex flex-column gap_14 my-4">
								<span class="card_label"><?php echo $this->lang->line('Writings_Time');?></span>
							...
							<div class="form-group col-sm-4 d-flex flex-column gap_14 my-4">
								...
								<span class="value d-flex" style="gap: 8px;align-items: baseline;"><a href="<?=base_url('uploads/case_file/' . $files[0]["name"]);?>"><?php echo $files[0]['name']; ?> <i class="fa fa-download"></i></a></span>
							</div>
