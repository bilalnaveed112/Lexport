...
<?php if ($lan =='ar') { ?>
<?php if ($role_id == 3 && $sub == 'admin_notification_api') { ?>
    <!-- Email Body -->
    <tr>
    	<td style="color:#c8a458; font-size:32px;" align="center">رمزرسالة جديدة</td>
    </tr>
    <tr>
...
<?php if ($role_id == 3 && $sub == 'loginotp') { ?>
    ...
    <tr>
    	<td style="color:#7a7b7e; font-size:18px; padding:20px 100px 20px 100px; line-height:28px;" align="center">
<?php echo $otp; ?> شريكنا العزيز: مرحباً بك في برنامج نصر للدخول يرجى إضافة رمز التفعيل :  
...
<?php if ($role_id == 3 && $sub == 'admin_notification_api') { ?>
    <!-- Email Body -->
    <tr>
    	<td style="color:#c8a458; font-size:32px;" align="center">New Message</td>
    </tr>
    <tr>
    	<td style="color:#7a7b7e; font-size:18px; padding:20px 100px 20px 100px; line-height:28px;" align="center">
        <?php echo $message; ?>
...
<?php if ($role_id == 3 && $sub == 'admin_notification') { ?>
    <!-- Email Body -->
    <tr>
    	<td style="color:#c8a458; font-size:32px;" align="center">رمزرسالة جديدة</td>
    </tr>
    ...
    <tr>
    	<td align="center" style="background:#102b4e;">
        	<table cellpadding="0" cellspacing="0" border="0" width="700" align="center" style="background:#102b4e;">
                ...
                <tr>
                    <?php if ($lan =='ar' || $this->session->userdata('site_lang')=="arabic" ) { ?>
                ...
                <tr>
                    <td style="color:#c8a458; font-size:22px;" align="center">
                        
                           <?php if ($lan =='ar' || $this->session->userdata('site_lang')=="arabic") { ?> تواصل معنا  <?php } else { ?> Connect With Us <?php } ?>
                ...
                <tr><td height="40"></td></tr>
                  <tr>
        <td style="color: #ffffff; border-top: 1px solid #5f5f5f; font-size: 20px; padding: 5px;" align="center">Tel. 920002916 Riyad . Jeddah . Makkah</td>
    </tr>
            </table>
        </td>
    </tr>
