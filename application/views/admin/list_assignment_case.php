                ...
                <div class="m-portlet__head-caption">
                    <!-- <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            <?php echo $this->lang->line('File_Assignment_List');?>
                        </h3>
                    </div> -->
               ...
               <ul class="nav nav-tabs" role="tablist">
                ...
                <div class="">
                    ...
                    <div class="tab-pane active" id="m_tabs_3_2" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle=" " href="<?=base_url('admin/assignment/list_assignment_case');?>" data-target="#m_tabs_1_1"><?php echo $this->lang->line('All');?></a>
                            </li>
                            <li class="nav-item">
        ...
        background: #ffffff;
                        ...
                        <div class="tab-content">
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <table class="lp-theme-table lp-large-theme" id="m_datatable">
                                                ...
                                                <tr class="netTr" style="text-align:left;">
                                                    ...
                                                    <th class="sortable"><?php echo $this->lang->line('Responsible_Employee');?><img class="sortIcon" src="../../assets/images/img/arrow_up1.svg" height="18px"></th>
                                                    <th class="sortable"><?php echo $this->lang->line('Following_Employee');?><img class="sortIcon" src="../../assets/images/img/arrow_up1.svg" height="18px"></th>
						  ...
						  <tr class="hide<?php echo $case['id'] ?>" style="text-align: left;">
							...
							<td><?php  echo getEmployeeName($case['responsible_employee']);  ?> </td>
							<td><?php  echo getEmployeeName($case['follow_up_employee']);  ?></td>
							<td><?php echo getTheDayAndDateFromDatePan($case['case_date']);?></td>
							<td><?php  if($case['responsible_employee'] ==  $this->session->userdata('admin_id')){  }  echo $case['assign_note']; ?></td>
						...
						if(empty($case['case_id'])){ ?>
							...
							<a href="javascript:;" id="<?= $case['id'] ?>"  class="fa fa-trash" title="<?php echo $this->lang->line('Delete');?>">
							</a>
						...
						?>	 <?php } ?>
									...
									<a href="<?= base_url("admin/c_case/edit_case/{$case['id']}"); ?>" class="fa fa-edit" title="<?php echo $this->lang->line('Edit_On_File');?>">
					
									</a>
					 
									<a href="<?= base_url("admin/c_case/view_case/{$case['id']}") ?>" class="fa fa-eye" title="<?php echo $this->lang->line('View');?>">
	
									</a>
									<a href="javascript:;" data-toggle="modal" id="<?= $case['case_id'] ?>" data-target="#myModal" class="fa fa-calendar assign_type" title="<?php echo $this->lang->line('New_Mission');?>">
								
									</a>
						
						<?php if($case['customers_id'] == $case['customer_id'] || $this->session->userdata('role_id') == 1){  ?> 
 
							<a href="javascript:;" data-user="<?= $case['customers_id'] ?>" id="<?= $case['id'] ?>" class="fa fa-user-plus assign_case" title="<?php echo $this->lang->line('Assign');?>">
							</a>
						
									<a href="javascript:;"  data-user="<?= $case['case_id'] ?>" id="<?= $case['id'] ?>"  class="fa fa-refresh convert_case" title="<?php echo $this->lang->line('Convert_Case');?>">
...
//$("#m_datatable").on("change", "#type", function() {
