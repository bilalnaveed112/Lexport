 ...
 Back</a>
		...
		?>
				...
				<?php } ?>
					...
					<a href=<?= base_url("admin/$control/reject_pending_mission/{$appoinment['id']}") ?>  title="<?php echo $this->lang->line('Rejected');?>" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill  "><i class="fa fa-close"></i></a> 
					<?php } ?>
