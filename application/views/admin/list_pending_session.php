 <?php include "header.php";?>
    <div class="breadcrumbs">
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                       <li class="active">Dashboard/Session Pending List</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div id="msg" class="sufee-alert alert with-close alert-success alert-dismissible fade show success"></div>
		    ...
		    <strong class="card-title"><div class="employeeFilterTop">
		...
		<div class="card-body">
          <table id="m_datatable" class="table table-striped table-bordered">
            ...
            <tbody>
			  ...
			  <?php if($appoinment['responsible_employee'] == $this->session->userdata('admin_id') || $this->session->userdata('role_id') == 1){  ?>
					<a href=<?= base_url("admin/appoinment/approve_pending_appoinment/{$appoinment['id']}") ?>  title="View Case " class="btn btn-outline-success">Approve</a>  
					 <?php if($appoinment['is_reject']==1){  ?>
					 	<a href="#" title="View Case " class="btn btn-danger">Rejected</a> 
					 <?php } ?>
					 <?php if($appoinment['is_reject']==0){  ?>
					<a href=<?= base_url("admin/appoinment/reject_pending_appoinment/{$appoinment['id']}") ?>  title="View Case " class="btn btn-danger">Reject</a> 
					<?php } ?>
					<?php } ?>
                </td>
              </tr>
