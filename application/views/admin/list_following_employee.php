              ...
              <ul class="nav nav-tabs" role="tablist">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="m_tabs_3_1" role="tabpanel">
						...
						<a href="javascript:;" id="<?= $case['id'] ?>" class="fa fa-trash delete_case" title="<?php echo $this->lang->line('Delete');?>">
						...
						<a href="<?= base_url("admin/c_case/view_case/{$case['id']}") ?>" class="fa fa-eye" title="<?php echo $this->lang->line('View');?>">
							...
							<a href="javascript:;" data-toggle="modal" id="<?= $case['case_id'] ?>" data-target="#myModal" class="fa fa-calendar assign_type" title="<?php echo $this->lang->line('Book_Appointment');?>">
