                ...
                <div class="m-portlet__head-caption">
                    <!-- <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            <?php echo $this->lang->line('E_Service_assignment');?>
                        </h3>
                    </div> -->
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <div class="tab-pane" id="m_tabs_3_2" role="tabpanel">
                       ...
                       <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle=" " href="<?=base_url('admin/assignment/list_responsible_employee');?>" data-target="#m_tabs_1_2"><?php echo $this->lang->line('Responsible_Employee');?></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-pane active" id="m_tabs_1_2" role="tabpanel">
                                <div class="m-portlet__body">
                                    ...
                                    <table class="lp-theme-table lp-large-theme" id="m_datatable">
                                                ...
                                                <tbody>
						<?php $i=0; foreach ($list as $case){ $i++;  if($case['user_id'] != 0) { ?>
						...
						<a href="javascript:;" id="<?= $case['id'] ?>" class="btn btn-outline-danger delete_case" title="<?php echo $this->lang->line('Delete');?>"><i class="fa fa-trash"></i></a>
						...
						<?php if($case['responsible_employee'] == $case['user_id']){ ?>
						...
						<?php if($case['user_id'] == $this->session->userdata('admin_id') || $this->session->userdata('role_id') == 1){  ?>
