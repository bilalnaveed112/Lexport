    <style>
        ...
        .m-portlet__body.theme-inner-form .form-field-container .form-control-label {
            font-weight: 400;
        }

        .form-group.m-form__group .form-control-label strong {
            display: block;
            margin-bottom: 15px;
        }
    </style>
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
                    ...
                    <!-- <div class="m-portlet__head">
                        ...
                        <ul class="list-detail-ul">
                            ...
                            <li><h3><b><?php echo $this->lang->line('Date');?>:</b> <?php  echo getTheDayAndDateFromDatePan($data->session_date); ?></h3>
                        </li>
                    </ul>
           ...
           <div class="form-group col-sm-6">
			...
			<div class="form-group col-sm-6">
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('General_Type');?>: </strong><?php echo $data->general_type; ?></label>
			</div>
			<div class="form-group col-sm-6">	
			...
			<div class="form-group col-sm-6">
				<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('General_Number');?>: </strong><?php echo $data->session_number; ?></label>
			</div>
			<div class="form-group col-sm-6">
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('General_Date');?>: </strong><?php  echo getTheDayAndDateFromDatePan($data->session_date); ?></label>
			</div>
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('General_Time');?>: </strong><?php echo $data->session_time; ?></label>
			</div>
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('General_End_Date');?>: </strong><?php echo getTheDayAndDateFromDatePan($data->session_end_date);  ?></label>
			</div>
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('General_End_Time');?>: </strong><?php echo $data->session_end_time; ?></label>
			</div>
			<div class="form-group col-sm-6">	
			...
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('E_Service_Date');?>: </strong><?php  echo getTheDayAndDateFromDate($data->case_date); ?></label>
			</div>
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('E_Service_Start_Date');?>: </strong><?php echo getTheDayAndDateFromDate($data->case_start_date); ?></label>
			</div>
			<div class="form-group col-sm-6">	
			...
			<div class="clear"></div>
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('Entry_No');?>: </strong><?php echo $data->entry_no; ?></label>
			</div>
			<!--<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong>Import Entry No: </strong><?php echo $data->import_entry_no; ?></label>
			</div>
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong>Export Entry No: </strong><?php echo $data->export_entry_no; ?></label>
			</div>-->
			
			<div class="form-group col-sm-6">	
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('Decision');?>: </strong><?php echo $data->decision; ?></label>
			</div>
			...
			<label for="court_name" class=" form-control-label"><strong><?php echo $this->lang->line('Requirement');?>: </strong><?php echo $data->note; ?></label>
                                	...
                                	<div class="form-field-container">
										...
										<div class="m-widget4">
                                            ...
                                            <?php  $case_id = $data->session_number; ?>
                                                ...
                                                <?php 
                                                    $cisd = $data->case_id;
                                                    $audio = $this->db->select('audio,id')->where('audioid',$case_id)->where('type','general')->get('uploads')->result_array();
                        ...
                        <!-- <div class="row thh">
                            <div class="col-lg-12">
                                <h3 style="color:#fff"><?php echo $this->lang->line('Audio_Record_List');?></h3>
                            </div>
                        </div>
                        <div class="in_fo">
