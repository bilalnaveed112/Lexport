...
<th><?php echo $this->lang->line('Subject');?> <br><i class="fa fa-arrow-up" style="font-size: 10px;font-weight: normal"></i><i class="fa fa-arrow-down" style="font-size: 10px;font-weight: normal"></i></th><th><?php echo $this->lang->line('Date');?><br><i class="fa fa-arrow-up" style="font-size: 10px;font-weight: normal"></i><i class="fa fa-arrow-down" style="font-size: 10px;font-weight: normal"></i></th>
               ...
               <!-- <th>Responsible Employee<br><i class="fa fa-arrow-up" style="font-size: 10px;font-weight: normal"></i><i class="fa fa-arrow-down" style="font-size: 10px;font-weight: normal"></i></th>-->
                ...
                <tbody>
                <?php 
              $count=1;foreach($list_customer as $list_customer) { 
			...
			?>
				...
				<?php } ?>
									<?php if(in_array($this->session->userdata('admin_id'),getFileManager()) || $this->session->userdata('role_id')==1){ ?>
					<a href=<?= base_url("admin/$control/approve_mission/{$appoinment['id']}") ?>  title="<?php echo $this->lang->line('Close');?>" class=" btn btn-success" ><?php echo $this->lang->line('Close');?></a>
				<?php }?>
                </td>
              </tr>
            <?php } ?> 
