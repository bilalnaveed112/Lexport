...
<th><?php echo $this->lang->line('Subject');?> <br><i class="fa fa-arrow-up" style="font-size: 10px;font-weight: normal"></i><i class="fa fa-arrow-down" style="font-size: 10px;font-weight: normal"></i></th>	<th><?php echo $this->lang->line('Date');?></th>
		...
		?>
				...
				<td><span class='countdown' style=" color: #0e8a00; font-weight: bold; " 
		          ...
		          <td class="action">
					...
					<a href=<?= base_url("admin/$control/find_mission/{$appoinment['id']}") ?> class="fa fa-edit" id=<?= $appoinment['id'] ?> title="<?php echo $this->lang->line('Edit');?>"></a>
					<?php } ?>
				...
				<?php } ?>
					...
					<a href=<?= base_url("admin/$control/approve_pending_mission/{$appoinment['id']}") ?>  title="<?php echo $this->lang->line('Approve');?>" class="fa fa-check"></a>
					<?php } ?>
					...
					<a href=<?= base_url("admin/$control/reject_pending_mission/{$appoinment['id']}") ?>  title="<?php echo $this->lang->line('Close');?>" class="fa fa-close"></a> 
					<?php } ?>
                </td>
              </tr>
            <?php } ?>
