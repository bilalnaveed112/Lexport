 ...
 <ul>
      ...
      <?php  
		...
		?>
				...
				<td><span class='hidetd'><?php echo getdateforshorting($appoinment['session_date']); ?></span><?php echo getTheDayFromDate($appoinment['session_date']);  ?></td>
				...
				<?php if(in_array($this->session->userdata('admin_id'),getFileManager()) || $this->session->userdata('role_id')==1){ ?>
					<a href=<?= base_url("admin/$control/approve_mission/{$appoinment['id']}") ?>  title="<?php echo $this->lang->line('Approve');?>" class=" btn btn-success" ><?php echo $this->lang->line('Close');?></a>
				<?php }?>
                </td>
              </tr>
            <?php } ?>
