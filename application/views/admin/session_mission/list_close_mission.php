                        ...
                        <div class="m-portlet__body">
                            <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded" style="">
                                ...
                                <div class="table-responsive">
                                    <table class="lp-theme-table lp-large-theme last-item-auto" id="m_datatable">
                                        <thead>
                                       <tr class="netTr">
    ...
    <?php 
		...
		?></td>
			 ...
			 <td><?php echo clsoe_diff($appoinment['session_end_date'],$appoinment['session_end_time'],$appoinment['close_date']); ?></td>
					...
					<a href="<?= base_url("admin/$control/view_mission/{$appoinment['id']}") ?>" id="readnotificaion" data-read="<?php echo $appoinment['id']; ?>" title="<?php echo $this->lang->line('View');?>" class="fa fa-eye" ></a>
					<?php } ?>
				<?php if($appoinment['report_file']) {?>
					...
					if($files){
					?>
					<a href=<?= base_url("admin/$control/view_mission/{$appoinment['id']}/#attechmntrec") ?><?php //base_url("/uploads/case_file/{$files->name}") ?>  title="<?php echo $this->lang->line('Download_Mission');?>" class="fa fa-file " target="_blnak"> <?php echo $this->lang->line('Attachment');?></a>
					<?php } ?> </span>
