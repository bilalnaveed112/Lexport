<table cellpadding="0" cellspacing="0" border="0" width="800" align="center" style="background:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:22px; font-weight:normal;">
	<tr>
    	<td style="background:#f3f3f3; padding:20px 15px 20px 15px;">
        	<table cellpadding="0" cellspacing="0" border="0" width="800">
            	<tr>
                	<td align="left" width="400"><img src="<?php echo base_url();?>assets/images/pdf-logo.png" alt="" height="100" border="0" style="display:block; margin:0px;" /></td>
                	<td align="right" width="400" style="font-size:30px; color:#421F23; font-weight:bold; text-align:right;">Consultation Report</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
    	<td style="padding:20px 15px 20px 15px;">
			...
			<?php if($i == 1) { ?>
				<tr>
                	<td width="170" style="background-color:#421F23; color:#ffffff; margin:0px 10px 0px 0px; padding:10px 10px 10px 20px; border-radius:30px 30px 30px 30px; font-weight:bold;">Consultation Date</td>
                    <td width="10">&nbsp;</td>
				<?php } ?>	
				...
				<?php if($i == 1) { ?>
				<tr>
                	<td width="170" style="background-color:#421F23; color:#ffffff; margin:0px 10px 0px 0px; padding:10px 10px 10px 20px; border-radius:30px 30px 30px 30px; font-weight:bold;">Next Consultation Date</td>
                    <td width="10">&nbsp;</td>
				<?php } ?>	
