		...
		?>      <div class="m-portlet__body theme-inner-form">
                            ...
                            <div class="form-group m-form__group row">
								<div class="form-group col-sm-4">
									<label for="session_number" class=" form-control-label"><?php echo $this->lang->line('Consultation_Number');?></label>
									<?php if($data)
									{
									...
									{
										if($sub_mission_id){
										$sct = str_pad(getMissionCount($sub_mission_id,"consultation_mission") + 1, 2, 0, STR_PAD_LEFT);
											$session_number=set_value('session_number',getMissionNumber($this->uri->segment(5),'consultation_mission')."/".$sct);
										} else {
											$session_number=set_value('session_number', mission_rand($case_id,'CN'));
										}
								...
								<div class="form-group col-sm-4">
									...
									<div class="input-group date">
										<?= form_input(['name'=>'session_end_time','id'=>'session_end_time','autocomplete'=>'off','required'=>'required','class'=>'form-control deedate','value'=>$value]);?>
									<div class="input-group-append">
									<span class="input-group-text"><i class="fa fa-clock-o"></i></span>
									</div>
									</div>
								...
								<div class="form-group col-sm-4">
									...
									<select class="form-control" id="" value="" name="responsible_employee" value=""><option value=""><?php echo $this->lang->line('Select_Employee');?> </option><?php  foreach ($employees as $employee) { ?><option value="<?php echo $employee["id"]?>"  <?php if($value ==  $employee["id"]) echo "selected=selected";?><?php if($case_data->responsible_employee ==  $employee["id"]) echo "selected=selected";?> ><?php echo $employee["name"]?></option><?php } ?></select>
		...
		display: block;
                            ...
                            <div class="col-md-6">
												...
												<div class="m-widget4__item">
													<table class="lp-theme-table lp-large-theme">
														<tbody>
															<tr>
																<td>
																	<?php echo "<b>" . $audio['audio']."</b>"; ?></span><br>
                                ...
                                <div class="form-field-container">
                                    ...
                                    <div class="m-widget4">
										<?php
											$file = $this->db->select('*')->where("(temp_app_id = '$temp_app_id' AND cat_id = 8 AND type='consultati')", NULL, FALSE)->get('document')->result_array();
											  	...
											  	<div class="m-widget4__item"> 
													<div class="m-widget4__info">
														...
														<span class="m-widget4__sub"><?php
															echo "<span class='empnm'>(Upoded By ".getEmployeeName($files['user_id']).")</span>";?>
														</span>
													</div>
							...
							<div class="form-field-container">
								<div class="row">
									<div class="col-12">
										...
										<a href="<?php echo base_url("admin/mission_consultation/add_mission/$case_id/".$data->id); ?>" class="btn btn-primary btn-lg">Add Session Sub Mission</a>
										<?php  } else { ?>
                    ...
                    <!-- </div> 
					<span class="audioocaseid" id="<?php echo $case_id; ?>"></span>
					<span class="sessionid" id="<?php echo $this->session->userdata('admin_id'); ?>"></span> <span class="type" id="consultati"></span>
					<span class="audioid" id="<?php echo $session_number; ?>"></span> -->
					...
					<?php if($data->is_close == 0){ ?>
						...
						if($this->session->userdata('role_id') == 1){
							...
							if($sub_mission_id  == ''  && $data->sub_mission_id == 0 AND checkAllMissionClose($data->id,'consultation_mission') == 0 ){
...
formData: {"fid":<?php echo $case_id; ?>,"cat_id":8, "type":"consultation","temp_app_id":<?php echo $temp_app_id; ?>},
dragdropWidth:400,
...
method:'post',
url:url,
data: {'note':note,'case_id':case_id,'type':'consultation','app_id':app_id},
