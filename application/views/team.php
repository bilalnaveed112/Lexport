                ...
                <div class="col-md-4">
                    ...
                    <div class="member">
                        ...
                        <div class="member-body">
                            <img src="<?php if($data['image']) echo base_url('uploads/team/'.$data['image']); else /*echo base_url('assets/images/img/no_avatar2.jpg');*/ echo base_url('uploads/team/365791156.jpg'); ?>" alt="">
                        ...
                        <div class="member-description">
                            ...
                            <?php 
                                    ...
                                    ?>
                                     <h4><?= $data['name_ar']; ?></h4>
                            <h4 class="colored"><?= $data['designation_ar']; ?></h4>
                            <p class="colored"><?= $data['discription_ar']; ?></p>
                                    <?php
