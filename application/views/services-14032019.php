            ...
            <div class="modern-tabs-container clearfix t-left no-border ">
                <div class="row border-gray2">
                    <ul class="nav nav-tabs modern-tabs vertical-tabs col-sm-3 col-12 xxs-px-mobile font-11 bg-white gray8 uppercase bold xs-mt" role="tablist">
                        ...
                        <li role="presentation"><a href="#tab3f" aria-controls="tab3f" role="tab" data-toggle="tab" class="bg-colored border-colored white"><?php //echo $this->lang->line('Execution_of_Judgments_and_Collection_of_Debts');
						echo $this->lang->line('Drafting_Legal_Pleading');?></a></li>
                        <li role="presentation"><a href="#tab4f" aria-controls="tab4f" role="tab" data-toggle="tab" class="bg-colored border-colored white"><?php echo $this->lang->line('Litigation_and_Pleadings');?></a></li>
                        <li role="presentation"><a href="#tab5f" aria-controls="tab5f" role="tab" data-toggle="tab" class="bg-colored border-colored white"><?php echo $this->lang->line('Settlement_of_Succession_Awqaf_Management');?></a></li>
                        <li role="presentation"><a href="#tab6f" aria-controls="tab6f" role="tab" data-toggle="tab" class="bg-colored border-colored white"><?php echo $this->lang->line('Business_and_Companies');?></a></li>
                        <li role="presentation"><a href="#tab7f" aria-controls="tab7f" role="tab" data-toggle="tab" class="bg-colored border-colored white"><?php echo $this->lang->line('Arbitration_and_Mediation');?></a></li>
                        <li role="presentation"><a href="#tab8f" aria-controls="tab8f" role="tab" data-toggle="tab" class="bg-colored border-colored white"><?php echo $this->lang->line('Documentation_and_Execution');?></a></li>
                    </ul>
                    <!-- Tab panes -->
                            ...
                            <div id="tab3f" role="tabpanel" class="tab-pane">
                                <div class="tab-container dropcap dropcap-bg dropcap-lg danger-bg dropcap-radius">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <h1 class="bold-title ">
                                                <span class="playfair italic"><?php //echo $this->lang->line('Execution_of_Judgments_and_Collection_of_Debts'); 
												echo $this->lang->line('Drafting_Legal_Pleading');?></span>
                                            </h1>
                                            <!--<h4 class="xs-my gray6">
												<?php echo $this->lang->line('Execution_of_Judgments_and_Collection_of_Debts_p1');?>
                                            </h4>-->
                                            <ul class="list list-circle xs-pt underline-hover-links font-16 bold-subtitle">
                                                <?php echo $this->lang->line('Drafting_Legal_Pleading_p1');?>
                                            </ul>
                                        </div>
                                        <!-- End Right Texts -->
                                    </div>
                            ...
                            <div id="tab4f" role="tabpanel" class="tab-pane">
                                <div class="tab-container dropcap dropcap-bg dropcap-lg dropcap-border light-bg dropcap-radius">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <h1 class="bold-title ">
                                                <span class="playfair italic"><?php //echo $this->lang->line('Liquidation_of_Legacies_and_Management_of_Endowments');
												echo $this->lang->line('Litigation_and_Pleadings');?></span>
                                            </h1>
                                            <h4 class="xs-my gray6">
												<?php //echo $this->lang->line('Liquidation_of_Legacies_and_Management_of_Endowments_p1');
												echo $this->lang->line('Litigation_and_Pleadings_p1');?>
                                                
                                            </h4>
                                            <ul class="list list-circle xs-pt underline-hover-links font-16 bold-subtitle">
                                                <?php //echo $this->lang->line('Liquidation_of_Legacies_and_Management_of_Endowments_p2');
												echo $this->lang->line('Litigation_and_Pleadings_p2');?>
                                            </ul>
                                        </div>
                                        <!-- End Right Texts -->
                            ...
                            <div id="tab5f" role="tabpanel" class="tab-pane">
                                <div class="tab-container dropcap dropcap-bg dropcap-lg secondary-bg dropcap-radius">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <h1 class="bold-title ">
                                                <span class="playfair italic"><?php //echo $this->lang->line('Companies_and_Trade_Business');
												echo $this->lang->line('Settlement_of_Succession_Awqaf_Management');?></span>
                                            </h1>
                                            <!--<h4 class="xs-my gray6">
                                            ...
                                            <ul class="list list-circle xs-pt underline-hover-links font-16 bold-subtitle">
												...
												echo $this->lang->line('Settlement_of_Succession_Awqaf_Management_p1');?>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab6f" role="tabpanel" class="tab-pane">
                                <div class="tab-container dropcap dropcap-bg dropcap-lg secondary-bg dropcap-radius">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <h1 class="bold-title ">
                                                <span class="playfair italic"><?php //echo $this->lang->line('Arbitration_and_Mediation');
												echo $this->lang->line('Business_and_Companies');?></span>
                                            </h1>
                                            <!--<h4 class="xs-my gray6">
                                            ...
                                            <ul class="list list-circle xs-pt underline-hover-links font-16 bold-subtitle">
												...
												echo $this->lang->line('Business_and_Companies_p1');?>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="tab7f" role="tabpanel" class="tab-pane">
                                <div class="tab-container dropcap dropcap-bg dropcap-lg secondary-bg dropcap-radius">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <h1 class="bold-title ">
                                                <span class="playfair italic"><?php //echo $this->lang->line('Litigation');
												echo $this->lang->line('Arbitration_and_Mediation');?></span>
                                            </h1>
                                            <!--<h4 class="xs-my gray6">
                                            ...
                                            <ul class="list list-circle xs-pt underline-hover-links font-16 bold-subtitle">
												...
												echo $this->lang->line('Arbitration_and_Mediation_p2');?>
                                            </ul>
                                        </div>
                                        <!-- End Right Texts -->
                                    </div>
                            ...
                            <div id="tab8f" role="tabpanel" class="tab-pane">
                                <div class="tab-container dropcap dropcap-bg dropcap-lg secondary-bg dropcap-radius">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <h1 class="bold-title ">
                                                <span class="playfair italic"><?php //echo $this->lang->line('Documentation');
												echo $this->lang->line('Documentation_and_Execution');?></span>
                                            </h1>
                                           <!-- <h4 class="xs-my gray6">
                                            ...
                                            <ul class="list list-circle xs-pt underline-hover-links font-16 bold-subtitle">
												...
												echo $this->lang->line('Documentation_and_Execution_p1');?>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
