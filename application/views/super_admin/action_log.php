 ...
 <hr>
 	...
 	<div class="post-list" id="postList">
				...
				<?php if($post['action_type'] == "login") { ?>
					...
					<?php } ?>	
					<?php } ?>	
				<?php if($post['action_type'] == "logout") { ?>
					<?php if($post['status_type'] == "customer") { ?>
						<div class="list-item"><p><?php echo $this->lang->line('The_user');?> <b><?php echo getEmployeeName($post['customer_id']); ?></b> <?php echo "Logout";// echo $this->lang->line('has_been_logged_in');?><small><i class="float-right">&nbsp;<?php echo $date; ?></small></i></p></div>
					<?php } ?>	
