        ...
        <div class="m-content">
            ...
            <div id="custom-search-container"></div>
                <div class="m-portlet__head">
                    ...
                    <div class="m-portlet__head-title title-with-btn">
                            ...
                            <a href="<?=base_url('super_admin/administrator/add_user');?>" class="btn btn-primary m-btn btn-cst  m-btn--custom m-btn--icon m-btn--air" style="border-radius: 20px;">
                                        <span>
			...
			<?php $count=1; foreach($list as $admin){ ?>
                      <tr class="hide<?php echo $admin['id'] ?>">
                        ...
                        <td><?= $admin['created'] ?></td>
            <td class="action">
              <a href=<?= base_url("super_admin/administrator/find_user/{$admin['id']}") ?> class="fa fa-pencil-square-o" id=<?= $admin['id'] ?>></a>
