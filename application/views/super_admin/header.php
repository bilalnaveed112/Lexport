...
<head>
	...
	<link href="<?=base_url('assets');?>/demo/base/style.bundle.css" rel="stylesheet" type="text/css"/>
    <!-- CSS Files -->
...
<li class="m-nav__item m-topbar__languages m-topbar__user" m-dropdown-toggle="click" aria-expanded="true">
	<a href="" class="m-nav__link m-dropdown__toggle">
   	<span class="m-nav__link-text">		<span class="m-topbar__username" style="color: black !important;"><?php echo $this->lang->line('Welcome');?>,  <b> <?php //echo  getEmployeeName($this->session->userdata('admin_id')); ?> Super Admin</b>
	</span>
	</span>
	</a>
</li>
<!-- <li class="m-nav__item m-topbar__languages m-topbar__logout" m-dropdown-toggle="click" aria-expanded="true">
<a href="<?=base_url('super_admin/logout');?>" class="m-nav__link m-dropdown__toggle">
<span class="m-nav__link-text">
<span class="m-nav__link-icon"><i class="flaticon-logout" style="margin: 0;"></i></span>
</span>
</a>
</li> -->
<li class="m-nav__item m-topbar__languages m-topbar__lang2" m-dropdown-toggle="click" aria-expanded="true">
<?php if($this->session->userdata('admin_site_lang')=="arabic" OR $this->session->userdata('admin_site_lang')=="" ) { ?>
...
<?php } ?>
 ...
 <li class="m-nav__item m-topbar__languages m-dropdown m-dropdown--small m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--mobile-full-width m-topbar__profile" m-dropdown-toggle="click" aria-expanded="true">
	<a href="#" class="m-nav__link m-dropdown__toggle">
		<span class="m-nav__link-text">
				...
				<div class="m-dropdown__content">
					<ul class="m-nav m-nav--skin-light">
						<li class="m-nav__item m-nav__item--active">
							<a href="<?php echo base_url('super_admin/login/change_password'); ?>" class="m-nav__link m-nav__link--active">
						...
						<li class="m-nav__item">
							<a href="<?php echo base_url('super_admin/logout'); ?>" class="m-nav__link m-nav__link--active">
        ...
        <div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
            ...
            <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
                <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow">
                    ...
                    <li class="m-menu__item <?php  if($this->uri->segment('2')=='dashboard') echo ' m-menu__item--open m-menu__item--active'; ?>" aria-haspopup="true" >
                        <a href="<?=base_url('super_admin/dashboard');?>" class="m-menu__link link_men_bg dbg">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Dashboard');?></span>
                        </a>
                    </li> 
					
                    <li class="m-menu__item  <?php  if($this->uri->segment('3')=='list_admin') echo ' m-menu__item--open m-menu__item--active'; ?>" aria-haspopup="true">
                        <a href="<?=base_url('super_admin/administrator/list_admin');?>" class="m-menu__link link_men_bg dbg7 ">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Admin');?></span>
                        </a>
                    </li> 
                    <li class="m-menu__item  <?php  if($this->uri->segment('2')=='employee') echo ' m-menu__item--open m-menu__item--active'; ?>" aria-haspopup="true">
                        <a href="<?=base_url('super_admin/employee/list_employee');?>" class="m-menu__link link_men_bg dbg7 ">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Employee');?></span>
                        </a>
                    </li>  
					
                    <li class="m-menu__item <?php  if($this->uri->segment('3')=='list_user') echo ' m-menu__item--open m-menu__item--active'; ?>" aria-haspopup="true" >
                        <a href="<?=base_url('super_admin/administrator/list_user');?>" class="m-menu__link link_men_bg dbg7 ">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Users');?></span>
                        </a>
                    </li>  
					 <li class="m-menu__item  m-menu__item--submenu <?php  if($this->uri->segment('2')=='action_log') echo ' m-menu__item--open m-menu__item--active'; ?>" aria-haspopup="true" m-menu-submenu-toggle="hover">
                        <a href="javascript:;" class="m-menu__link link_men_bg dbg9 m-menu__toggle">
                            <span class="m-menu__link-text"><?php echo $this->lang->line('Log');?></span>
                        ...
                        <div class="m-menu__submenu">
                            ...
                            <ul class="m-menu__subnav">
                                ...
                                <li class="m-menu__item <?php  if($this->uri->segment('2')=='action_log?log=mission') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
                                    <a href="<?=base_url('super_admin/action_log?log=mission');?>" class="m-menu__link ">
                                        <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                        <span class="m-menu__link-text"><?php echo $this->lang->line('Mission');?></span>
                                    </a>
                                </li>
                                <li class="m-menu__item logout-list-item <?php  if($this->uri->segment('2')=='action_log?log=e-service') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
                                    <a href="<?=base_url('super_admin/action_log?log=e-service');?>" class="m-menu__link ">
                                        <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                        <span class="m-menu__link-text"><?php echo $this->lang->line('e-services');?></span>
                                    </a>
                                </li>
                                <li class="m-menu__item language-list-item <?php  if($this->uri->segment('2')=='action_log?log=emp') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
                                    <a href="<?=base_url('super_admin/action_log?log=emp');?>" class="m-menu__link ">
                                        <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                        <span class="m-menu__link-text"><?php echo $this->lang->line('Employee');?></span>
                                    </a>
                                </li>
                                <li class="m-menu__item profile-list-item <?php  if($this->uri->segment('2')=='action_log?log=clt') echo ' m-menu__item--active'; ?>" aria-haspopup="true">
                                    <a href="<?=base_url('super_admin/action_log?log=clt');?>" class="m-menu__link ">
                                        <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                ...
                <a class="side-logout-menu" href="<?=base_url('super_admin/logout');?>"> <img src="<?php echo base_url(); ?>/assets/images/img/logout-icon.svg" alt=""> Log out</a>
            </div>
