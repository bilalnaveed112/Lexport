...
<section id="content" class="sm-pb xxs-mb">
    ...
    <div class="row container">
        ...
        <div class="col-md-12 col-sm-12 mt mb">
		  <h2><?= $title; ?></h2>
         <div class="detailImg">
            <img src="<?php echo base_url('uploads/job/'.$data['image']);?>">
         </div>
		 <p><?= $description; ?></p>
		  
		 <a href="<?php echo base_url('front/job_employment/job/'.$data['id']);?>" class="bg-colored1 xl-btn font-12 xxs-mt slow width-auto click-effect white bold qdr-hover-6 radius-lg"><?php echo $this->lang->line('Apply_Now'); ?></a>
		</div>
        <!-- End Col -->
