...
$pageTitle = $this->lang->line("View_Session");
include('header.php');
...
span.m-widget4__ext {
    ...
    <?php } ?>
	.view_session_appointment {
		font-family: 'Roboto';
	}
	.view_session_appointment .m-portlet.lp-theme-card {
		background: unset;
		box-shadow: unset;
		padding: 0;
		border-radius: 0;
	}
	.view_session_appointment .m-portlet.lp-theme-card .m-portlet__body .in_fo {
		background: #fff;
		margin-left: 0;
	}
	.view_session_appointment span.card_label {
        font-size: 16px;
        color: #868DA6;
        font-weight: bold;
    }

    .view_session_appointment span.value {
        font-size: 15px;
        color: #1B2A39;
    }
	.gap_14 {
	...
	.view_session_appointment .m-portlet__body .in_fo {
		border-radius: 20px;
	}

	html[dir="rtl"] .view_session_appointment .m-portlet__body .in_fo {
		margin-right: 0;
	}

	.view_session_appointment .form-group.m-form__group.row.sub-missions{
		padding-left: 15px;
		padding-right: 15px;
	}

	.view_session_appointment .m-portlet__head .m-portlet__head-title{
		gap: 20px;
	}
	html[dir="rtl"] .view_session_appointment .m-portlet__head a.back-link svg {
...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
        <!-- END: Subheader -->
        <div class="m-content view_session_appointment">
			...
			<div class="m-portlet__head">
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title d-flex">
						...
						<?php echo $this->lang->line('Sessions_View');?>
						</h3>
					</div>
				</div>
			</div>
				...
				<div class="m-portlet__body">
					...
					<div class="in_fo pt-4 mb-8">		
						<div class="form-group m-form__group row">
							...
							<div class="form-group col-sm-2 d-flex flex-column gap_14 my-4">
								<span class="card_label"><?php echo $this->lang->line('Session_Number');?></span>
								<span class="value"><?php echo $data->session_number; ?></span>
							</div>
							<div class="form-group col-sm-2 d-flex flex-column gap_14 my-4">
								<span class="card_label"><?php echo $this->lang->line('Session_Date');?></span>
								<span class="value"><?php echo getTheDayAndDateFromDatePanFront($data->session_date); ?></span>
							</div>
							<div class="form-group col-sm-2 d-flex flex-column gap_14 my-4">
								<span class="card_label"><?php echo $this->lang->line('Session_Time');?></span>
					...
					<?php 
						...
						->where("(c_case.customers_id = $id  AND status=0)", NULL, FALSE)->where("session_mission.sub_mission_id",$temp_app_id)
						->get('session_mission')
						->result_array();
