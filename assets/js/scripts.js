...
$(window).on('load', function() {
    ...
    $(window).on('click touchstart touch', function(event){$('.quick-contact-form2').fadeOut("fast").removeClass('active'); $('body').removeClass('quick-contact-form2-active');});
    $('.drop-msg2, .quick-contact-form2-trigger').on('click touch', function(){ $('.quick-contact-form2').fadeToggle("fast").toggleClass('active'); $('body').toggleClass('quick-contact-form2-active');  return false;});
    $('.quick-contact-form2, .drop-msg2, .quick-contact-form2-trigger, #error_message').on('click touch touchstart', function(event){ event = event || window.event; event.stopPropagation();});
